...
| MS_AI_Development_Orchestration_Plan_v1.0.md | `docs/architecture/MS_AI_Development_Orchestration_Plan_v1.0.md` | AUTHORITATIVE | AUTHORITATIVE | v1.0 | Fejlesztési orchestration forrásdokumentum. |
...
| MernokSzem_BrandBook_v1.0_brandcsalad.docx | `docs/brand/source/MernokSzem_BrandBook_v1.0_brandcsalad.docx` | AUTHORITATIVE | AUTHORITATIVE | v1.0 | Brand source document. |
