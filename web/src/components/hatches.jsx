...
export const HATCHES = [
  { id: "solid", label: "Tömör" },
  { id: "diag", label: "Átlós" },
  { id: "diag2", label: "Fordított átlós" },
  { id: "cross", label: "Keresztsraff" },
  { id: "diagdense", label: "Sűrű átlós" },
  { id: "horiz", label: "Vízszintes" },
  { id: "vert", label: "Függőleges" },
  { id: "grid", label: "Négyzetrács / lap" },
  { id: "brick", label: "Tégla / kötés" },
  { id: "plank", label: "Deszka / fa" },
  { id: "herring", label: "Halszálka" },
  { id: "basket", label: "Kosárfonás" },
  { id: "checker", label: "Sakktábla" },
  { id: "wave", label: "Hullám" },
  { id: "dots", label: "Homok / pontok" },
  { id: "speckle", label: "Terrazzo" },
  { id: "iso", label: "Izometrikus rács" },
  { id: "honeycomb", label: "Méhsejt" },
  { id: "scan", label: "Pásztázó vonal" },
  { id: "plus", label: "Pluszrács" },
  { id: "circuit", label: "Áramköri minta" },
  { id: "topo", label: "Szintvonal" },
  ...
  { id: "woodgrain", label: "Faerezet" },
  { id: "chevron", label: "Chevron" },
  { id: "pinwheel", label: "Forgó minta" },
  { id: "harlequin", label: "Rombusz" },
  { id: "hexagon", label: "Hatszögletű lap" },
  { id: "penny", label: "Körmozaik" },
  { id: "octagondot", label: "Nyolcszög és pont" },
  { id: "fleur", label: "Liliom" },
  { id: "concrete", label: "Beton / pontozás" },
];
